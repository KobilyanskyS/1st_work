...
?>
    ...
    <body>
            ...
            <div class="container" id="target-content">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <input type="hidden" id="fb_id" value="<?php echo $row["fb_id"]; ?>">
                        <div class="answer_controls" id="answerControls">
                            <a type="button" class="btn btn-primary" id="inviteBtn" data-bs-toggle="modal" data-bs-target="#invitemodal">Приглашение</a>
                            <a type="button" class="btn btn-outline-danger" id="waiverBtn" data-bs-toggle="modal" data-bs-target="#waivermodal">Отказ</a>
                        </div>

                        <div class="status_success" id="statusSuccess">
                        ...
                        <div class="status_waiver" id="statusWaiver">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h5 class="modal-title ml-2 d-none d-sm-block" id="exampleModalLabel">Сообщение для стажёра</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" data-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <h5 class="modal-title ml-2 d-block d-sm-none" id="exampleModalLabel">Сообщение для стажёра</h5>
                                        <div class="mt-2 form">
                                            <div class="mb-3">
                                                <label for="invite_message">Вы можете отправить стажёру контакты, адрес и прочую информацию, которую считаете нужной.</label>
                                                <textarea class="mt-2 form-control" name="invite_message" id="invite_message" cols="30" rows="5"></textarea>
                                            </div>
                                            <button type="submit" id="sendInviteBtn" class="btn btn-primary">Отправить сообщение с приглашением</button>
                                            <div class="invite_success">
                                                <div class="mt-3 alert alert-success d-flex align-items-center" role="alert">
                                                    ...
                                                    <div>
                                                        Сообщение с приглашением отправлено!
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="modal fade " id="waivermodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <a class="d-block d-sm-none" href="index.html">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mt-2 form">
                                            <div class="mb-3">
                                                <label for="waiver_message">Вы можете отправить стажёру причину отказа. Так Вы помогаете стажёрам стать лучше.</label>
                                                <textarea class="mt-2 form-control" name="waiver_message" id="waiver_message" cols="30" rows="5"></textarea>
                                            </div>
                                            <button type="submit" id="sendWaiverBtn" class="btn btn-danger">Отправить сообщение с отказом</button>
                                            <div class="waiver_success">
                                                <div class="mt-3 alert alert-danger d-flex align-items-center" role="alert">
                                                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:">
                                                        <use xlink:href="#check-circle-fill" />
                                                    </svg>
                                                    <div>
                                                        Сообщение c отказом отправлено!
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script src="js/getFeedbackStatus.js"></script>
        <script src="js/sendInviteAjax.js"></script>
        <script src="js/sendWaiverAjax.js"></script>
    </body>
