    ...
    <body>
        ...
        <nav id="target" class="navbar navbar-expand-lg navbar-light mb-2">
            <div class="container border-bottom pb-3">
                ...
                <a href="employer.php"><button type="button" class="btn-close" aria-label="Close"></button></a>
            </div>
        </nav>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-4 form">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="company_name" onchange="classList.remove('is-invalid')" name="company_name" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">ИНН компании</label>
                                <input type="text" class="form-control" id="company_inn" onchange="classList.remove('is-invalid')" name="company_inn" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Город</label>
                                <input type="text" class="form-control" id="city" onchange="classList.remove('is-invalid')" name="city" aria-describedby="emailHelp">
                            </div>
                            <h4>Контактное лицо</h4>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Имя</label>
                                <input type="text" class="form-control" id="contact_name" onchange="classList.remove('is-invalid')" name="contact_name" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Фамилия</label>
                                <input type="text" class="form-control" id="contact_surname" onchange="classList.remove('is-invalid')" name="contact_surname" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">E-mail</label>
                                <input type="email" class="form-control" id="contact_email" onchange="classList.remove('is-invalid')" name="contact_email" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Номер телефона</label>
                                <input type="text" class="form-control" id="contact_phone" onchange="classList.remove('is-invalid')" name="contact_phone" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control password" id="password_confirm" name="password-confirm">
                            </div>
                            ...
                            <p class="mt-2 text-muted">Уже зарегистированы? <a href="employer_login.php">Войти</a></p>
                        </div>
        ...
        <script src="js/employerSignUpAjax.js"></script>
