            ...
            <div class="container border-bottom pb-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div>
                        ...
                        <a type="button" class="btn btn-primary" href="index.php#loginmodal">Войти</a>
                    </div>
                </div>
            </div>
        </nav>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-4 form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="surname" onchange="classList.remove('is-invalid')" name="surname" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Ваш E-mail</label>
                                <input type="email" class="form-control" id="email" onchange="classList.remove('is-invalid')" name="email" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                            ...
                            <p class="mt-2 text-muted">Уже зарегистированы? <a href="index.php#loginmodal">Войти</a></p>
                        </div>
